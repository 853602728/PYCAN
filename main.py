...
def main():
    ...
    can = ControlCAN(can_devtype, can_devindex, can_canindex, can_baudrate, can_acccode, can_accmask, db_ip, db_user,
                     db_pass, db_schema, db_rtable, db_ttable, db_buffersize)
    can.createtable()
    can.opendevice()
    can.initcan()
    can.startcan()
